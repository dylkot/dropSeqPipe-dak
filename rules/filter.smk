...
rule cutadapt_R1:
    ...
    output:
        fastq_R1='{results_dir}/samples/{sample}/trimmmed_repaired_tmp_R1.fastq.gz',
        fastq_R2='{results_dir}/samples/{sample}/trimmmed_repaired_tmp_R2.fastq.gz'
    params:
    ...
    shell:
        ...
        -o {output.fastq_R1} -p {output.fastq_R2} {input.R1} {input.R2}\
        {params.extra_params} > {log.qc}"""

rule cutadapt_R2:
    input:
        R1='{results_dir}/samples/{sample}/trimmmed_repaired_tmp_R1.fastq.gz',
        R2='{results_dir}/samples/{sample}/trimmmed_repaired_tmp_R2.fastq.gz',
        adapters=config['FILTER']['cutadapt']['adapters-file']
    output:
        fastq_R1='{results_dir}/samples/{sample}/trimmmed_repaired_R1.fastq.gz',
        fastq_R2='{results_dir}/samples/{sample}/trimmmed_repaired_R2.fastq.gz'
    params:
    ...
    shell:
        ...
        -o {output.fastq_R2} -p {output.fastq_R1} {input.R2} {input.R1}\
        {params.extra_params} > {log.qc}"""
