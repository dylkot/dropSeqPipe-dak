...
rule bead_errors_metrics:
    ...
    output:
        temp('{results_dir}/samples/{sample}/final_unsorted.bam')
    params:
...
rule sort_index_bam:
    input:
        '{results_dir}/samples/{sample}/final_unsorted.bam'
    output:
    ...
    shell:
        '''samtools sort -T {params.temp_directory}/final.sorted -o {output} {input}; samtools index {output}'''
